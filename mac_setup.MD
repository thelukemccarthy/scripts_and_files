...
4. Setup the global settings for git  
    ...
    1. `git config --global push.autoSetupRemote true` This setting will auto create a branch in the remote when pushing.
...
18. Download and install Nushell `brew install nushell`
